...
//        //Toast.makeText(myContext, "check "+valuee, Toast.LENGTH_SHORT).show();
    ...
    public Cursor latlon(String place){
        SQLiteDatabase db = this.getWritableDatabase();


       // String query = "SELECT * FROM districts where bn_name ="+ff;
...
//        String query = "SELECT * FROM quran_verses where sura_id ="+valuee;
      ...
      /*  place = "ফরিদপুর";*/
        ...
        Cursor quaryaltlon = db.rawQuery("SELECT * FROM districts where bn_name= "+place,null);
